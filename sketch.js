...
function draw() {
  ...
  if (gameState === "round4") {
    ...
    bullet4 = createSprite(300, 570,5,13);
    bullet4.x = soldier1.x + 20
    bullet4.y = soldier1.y - 10
    bullet4.setVelocity(4, -4);
    bullet4.rotation = 60
    ...
    bullet4Group.collide(enemy_group,enemyHit)
...
function createEnemy(){
  for (var i = 1; i <=7; i++) {
    var enemy = createSprite(150*i,-50);
...
function enemyHit(bullet4, enemy) {
  bullet4.destroy();
  enemy.destroy();
  explosion.play();
}
